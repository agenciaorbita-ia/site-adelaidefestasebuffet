# [Nome da Agência] — ÓrbitaOS

> Modelo de CLAUDE.md aplicado a **agências** — equipe pequena entregando
> para múltiplos clientes ao mesmo tempo. O sistema é estruturado em torno
> de proposta, atendimento e produção em paralelo. O `/instalar` adapta
> este modelo à sua realidade.

## O que é esse workspace

[Uma frase que descreva o que esta pasta representa. Ex.: "Operação da
agência: aqui estão centralizados os clientes, propostas, conteúdo e entregas."]
...
[Lista breve. O `/atualizar` mantém esta lista sincronizada com as pastas em
`clientes/`.]
