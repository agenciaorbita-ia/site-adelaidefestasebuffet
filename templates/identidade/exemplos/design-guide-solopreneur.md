...
> Identidade visual aplicada em um cliente real do ÓrbitaOS — criador solo,
> marca pessoal, audience-first. Adapte a sua em `identidade/design-guide.md`.
...
Quente, humano e editorial. Tons terrosos com fundo off-white. Remete a um livro elegante ou a um diário de marca pessoal. O terracota (#C96442) aparece em CTAs, pills e destaques de texto.
...
- **Versão para fundo escuro:** identidade/logo-branco.png
