...
- **Contexto do negócio:** `_memoria/empresa.md` (para entender o que os dados representam)
...
Se o contexto estiver evidente pelo nome do arquivo ou pelo conteúdo, prosseguir sem perguntar.

### Passo 2 — Ler o arquivo

Ler o arquivo fornecido. Se for Excel (.xlsx), utilizar as ferramentas disponíveis para extrair o conteúdo das células.
...
Salvar em `estudos/analise-[nome]-[data].md` ou na pasta mais adequada ao perfil do usuário.

Perguntar se deseja exportar o resumo em HTML para compartilhamento ou apresentação.
